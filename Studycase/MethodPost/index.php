...
if (@$_POST['angka_pertama'] == "" || @$_POST['angka_kedua'] == "") {
    ...
    $B = $_POST['angka_pertama'] % $_POST['angka_kedua'];
    echo "<p style='text-align: center; margin: 10px 0;'>Hasil Sisa Bagi Dari " . "<b>" . 
    $_POST['angka_pertama'] . " % " . $_POST['angka_kedua'] . " = " . $B . 
    "</b>" . "</p>";
}
...
if (@$_POST['angka_pertama'] == "" || @$_POST['angka_kedua'] == "") {
    ...
    } elseif ($hasilSisabagi == 0) { // Jika hasil sisa bagi adalah 0
        echo "<p style='text-align: center; margin: 10px 0;'>0</p>";
    } else {
        echo "<p style='text-align: center; margin: 10px 0;'>Hasil Sisa Bagi Dari " . "<b>" . 
